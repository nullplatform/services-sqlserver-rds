locals {
  iam_module_name = "requirements-rds-sqlserver-db"
  iam_create      = var.iam_create_role

  role_name            = var.role_name != "" ? var.role_name : "nullplatform-${var.cluster_name}-rds-sqlserver-db-role"
